...
import logo from '../../images/logkjdfkjdfhdhjsdjfho.svg';
...
export class AppHeader extends React.Component {
    ...
    render() {
        ...
        return conversationBarOpen ? ( <
            ...
            <
            LanguageSelect key = "selectLanguage"
            ...
            md = { 2 } > {
                demoMode ? ( <
                    a href = "https://spg.ai/projects/articulate/"
                    target = "_blank" >
                    <
            ...
            md = { 2 } >
            {
                ...
                this.props.location.pathname !== '/' ? ( <
                    ...
                    Tooltip title = { intl.formatMessage(messages.shareAgent) }
                    placement = "bottom" >
                    <
                    img src = { shareIcon }
